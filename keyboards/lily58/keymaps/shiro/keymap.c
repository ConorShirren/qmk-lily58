 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LCtrl| LAlt | LGUI | /Space  /       \Space \  |RAISE |LOWER |RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,    KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, LGUI(KC_SPC), \
              KC_LCTRL, KC_LALT, KC_LGUI, MT(MOD_LSFT, KC_SPC) ,     MT(MOD_RSFT, KC_SPC),  MO(_RAISE), MO(_LOWER), KC_RGUI \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      | Home | PgDn |  F   |      |      |-------.    ,-------| PgDn | Left | Down |Right |   |  |Enter |
 * |------+------+------+------+------+------| Vol-  |    | Vol+  |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------|   _  |   -  |   =  |   +  |   \  |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
...
[_RAISE] = LAYOUT(\
  ...
  _______, _______, C(S(KC_TAB)), KC_F, C(KC_TAB), _______,             KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_PIPE, KC_ENT , \
  _______, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU  , KC_UNDS, KC_MINS, KC_EQL , KC_PLUS, KC_BSLS, _______, \
